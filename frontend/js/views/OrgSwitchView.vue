  ...
  <div class="mx-auto max-w-md">
    ...
    >
      <div class="relative">
        ...
        <div
          v-if="!appStore.org || !appStore.org.slug"
          class="absolute right-3 top-1/2 -translate-y-1/2"
        >
          <span class="inline-flex items-center rounded-full bg-gray-100 px-2 py-0.5 text-xs font-medium text-gray-600 ring-1 ring-inset ring-gray-500/20 dark:bg-gray-700 dark:text-gray-300 dark:ring-gray-500/30">Current</span>
        </div>
      </div>
      <div
        v-for="org in orgs"
